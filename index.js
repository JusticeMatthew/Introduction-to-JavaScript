...
function game(user, computer) {
  if (user.toLowerCase() === computer) {
    return "it's a tie";
  } else if (user.toLowerCase() === 'rock' && computer === 'paper') {
    return "you lose!";
  } else if (user.toLowerCase() === 'rock' && computer === 'scissors') {
    return "you win!";
  } else if (user.toLowerCase() === 'paper' && computer === 'scissors') {
    return "you lose!";
  } else if (user.toLowerCase() === 'paper' && computer === 'rock') {
    return "you win!";
  } else if (user.toLowerCase() === 'scissors' && computer === 'paper') {
    return "you win!";
  } else if (user.toLowerCase() === 'scissors' && computer === 'rock') {
    return "you lose!"
  }
...
function miles(kilometers) {
    let length = kilometers / 1.609344;
...
function grade(score) {
  if (score <= 100 && score >= 90) {
    ...
    return 'we do not speak of this'
  }
}
